...
public class FluxoCaixa {
    ...
    protected void retirarCaixa(float valor){dinheiroemcaixa = dinheiroemcaixa - valor;}
    
    protected void addDinheiroCaixa(float valor){dinheiroemcaixa = dinheiroemcaixa+valor;}
    ...
    protected void addContaAPagar(int valor){contasAPagar +=valor;}
